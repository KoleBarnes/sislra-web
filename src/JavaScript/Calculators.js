function speedConverter(source,valNum) {
  ...
  if (source=="inputQuarterMile") {
    ...
    input384Feet.value=(valNum/2.2).toFixed(3);
  }
  if (source=="inputEighthMile") {
    inputQuarterMile.value=(valNum*1.56).toFixed(3);
    input384Feet.value=(valNum*1.56/2.2).toFixed(3);
  }
  if (source=="input384Feet") {
    inputQuarterMile.value=(valNum*2.2).toFixed(3);
    inputEighthMile.value=(valNum/1.56*2.2).toFixed(3);
  }
}
